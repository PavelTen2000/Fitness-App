...
const Home = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section id="home" className="gap-16 bg-gray-20 py-10 md:h-full md:pb-0">
      ...
      >
        {/*  onViewportEnter - когда наведем на этот див то затригерится эта ф-ия*/}
        {/* main header */}
        ...
        {/* img */}
        <div
          className="md-z-10 flex basis-3/5 justify-center
        md:ml-40 md:mt-16 md:justify-items-end"
        >
          <img src={HomePageGraphic} alt="home-page-graph" />
        </div>
      </motion.div>
    ...
    // only apply when above media screens
  );
};
